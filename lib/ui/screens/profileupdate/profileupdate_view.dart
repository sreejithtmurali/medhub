...
import 'profileupdate_viewmodel.dart';

class ProfileUpdteView extends StatelessWidget {
  const ProfileUpdteView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<ProfileUpdteViewModel>.reactive(
      ...
      viewModelBuilder: () => ProfileUpdteViewModel(),
    );
  }
  ...
  Future<void> _selectDate(BuildContext context, ProfileUpdteViewModel model) async {
